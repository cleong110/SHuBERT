...
class AudioPretrainingConfig(FairseqDataclass):
    ...
    kmeans_label_paths: Optional[Dict[str, str]] = field(
        default=None,
        metadata={
            "help": "paths to k-means labels for different parts like face, left_hand, right_hand, body_posture"
        },
    )
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = FileAudioDataset(
                ...
                kmeans_label_paths=self.cfg.kmeans_label_paths,
                **self._get_mask_precompute_kwargs(task_cfg),
            )
